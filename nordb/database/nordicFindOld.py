"""
This module contains functions for finding similar events and determining what to do with them. WRITE THIS WHOLE THING AGAIN!!!
...
def checkForSameEvents(nordic_event, cur, ignore_duplicates):
    ...
    criteria = {
        "date":xstr(main.date),
        "hour":xstr(main.hour),
        "minute":xstr(main.minute),
        "second":xstr(main.second),
        "magnitude":xstr(main.magnitude_1),
        "latitude":xstr(main.epicenter_latitude),
        "longitude":xstr(main.epicenter_longitude)
    }
...
def checkForSimilarEvents(nordic_event, cur): 
    ...
    if main.epicenter_latitude is not None:
        ...
        values += (main.epicenter_latitude, )
    ...
    if main.epicenter_longitude is not None:
        ...
        values += (main.epicenter_longitude, )
