...
class Station:
    ...
    def latitude(self, val):
        val_latitude = validateFloat(val, "latitude", -90.0, 90.0, True, self.header_type)
    ...
    def longitude(self, val):
        val_longitude = validateFloat(val, "longitude", -180.0, 180.0, True, self.header_type)
    ...
    def elevation(self, val):
        val_elevation = validateFloat(val, "elevation", -10.0, 10.0, True, self.header_type)
    ...
    def station_name(self, val):
        val_station_name = validateString(val, "station_name", 0, 50, None, False, self.header_type)
    ...
    def station_type(self, val):
        val_station_type = validateString(val, "station_type", 1, 2, ['b', 'ss', 'bb', 'll', 'ar'], True, self.header_type)
    ...
    def reference_station(self, val):
        val_reference_station = validateString(val, "reference_station", 0, 6, None, False, self.header_type)
    ...
    def north_offset(self, val):
        val_north_offset = validateFloat(val, "north_offset", -100.0, 100.0, True, self.header_type)
    ...
    def east_offset(self, val):
        val_east_offset = validateFloat(val, "east_offset", -100.0, 100.0, True, self.header_type)
