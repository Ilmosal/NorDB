...
class NordicMain:
    ...
    location_model = property(operator.attrgetter('_location_model'))
    
    @location_model.setter
    def location_model(self, val):
        val_location_model = validateString(val, "location_model", 0, 1, "", False, self.header_type)
        self._location_model = val_location_model

    distance_indicator = property(operator.attrgetter('_distance_indicator'))
    
    @distance_indicator.setter
    def distance_indicator(self, val):
        val_distance_indicator = validateString(val, "distance_indicator", 0, 1, "LRD", True, self.header_type)
        self._distance_indicator = val_distance_indicator

    event_desc_id = property(operator.attrgetter('_event_desc_id'))
    
    @event_desc_id.setter
    def event_desc_id(self, val):
        val_event_desc_id = validateString(val, "event_desc_id", 0, 1, "", False, self.header_type)
        self._event_desc_id = val_event_desc_id

    epicenter_latitude = property(operator.attrgetter('_epicenter_latitude'))
    
    @epicenter_latitude.setter
    def epicenter_latitude(self, val):
        val_epicenter_latitude = validateFloat(val, "epicenter_latitude", -90.0, 90.0, True, self.header_type)
        self._epicenter_latitude = val_epicenter_latitude

    epicenter_longitude = property(operator.attrgetter('_epicenter_longitude'))
    
    @epicenter_longitude.setter
    def epicenter_longitude(self, val):
        val_epicenter_longitude = validateFloat(val, "epicenter_longitude", -180.0, 180.0, True, self.header_type)
        self._epicenter_longitude = val_epicenter_longitude

    depth = property(operator.attrgetter('_depth'))
    
    @depth.setter
    def depth(self, val):
        val_depth = validateFloat(val, "depth", 0.0, 999.9, True, self.header_type)
        self._depth = val_depth

    depth_control = property(operator.attrgetter('_depth_control'))
    
    @depth_control.setter
    def depth_control(self, val):
        val_depth_control = validateString(val, "depth_control", 0, 1, "FSGA", True, self.header_type)
        self._depth_control = val_depth_control

    locating_indicator = property(operator.attrgetter('_locating_indicator'))
    
    @locating_indicator.setter
    def locating_indicator(self, val):
        val_locating_indicator = validateString(val, "locating_indicator", 0, 1, "FS", True, self.header_type)
        self._locating_indicator = val_locating_indicator

    epicenter_reporting_agency = property(operator.attrgetter('_epicenter_reporting_agency'))
    
    @epicenter_reporting_agency.setter
    def epicenter_reporting_agency(self, val):
        val_epicenter_reporting_agency = validateString(val, "epicenter_reporting_agency", 0, 3, "", False, self.header_type)
        self._epicenter_reporting_agency = val_epicenter_reporting_agency

    stations_used = property(operator.attrgetter('_stations_used'))
    
    @stations_used.setter
    def stations_used(self, val):
        val_stations_used = validateInteger(val, "stations_used", 0, 999, True, self.header_type)
        self._stations_used = val_stations_used

    rms_time_residuals = property(operator.attrgetter('_rms_time_residuals'))
    
    @rms_time_residuals.setter
    def rms_time_residuals(self, val):
        val_rms_time_residuals = validateFloat(val, "rms_time_residuals", -9.9, 99.9, True, self.header_type)
        self._rms_time_residuals = val_rms_time_residuals

    magnitude_1 = property(operator.attrgetter('_magnitude_1'))
    
    @magnitude_1.setter
    def magnitude_1(self, val):
        val_magnitude_1 = validateFloat(val, "magnitude_1", -1.0, 9.9, True, self.header_type)
        self._magnitude_1 = val_magnitude_1

    type_of_magnitude_1 = property(operator.attrgetter('_type_of_magnitude_1'))
    
    @type_of_magnitude_1.setter
    def type_of_magnitude_1(self, val):
        val_type_of_magnitude_1 = validateString(val, "type_of_magnitude_1", 0, 1, "", False, self.header_type)
        self._type_of_magnitude_1 = val_type_of_magnitude_1

    magnitude_reporting_agency_1 = property(operator.attrgetter('_magnitude_reporting_agency_1'))
    
    @magnitude_reporting_agency_1.setter
    def magnitude_reporting_agency_1(self, val):
        val_magnitude_reporting_agency_1 = validateString(val, "magnitude_reporting_agency_1", 0, 3, "", False, self.header_type)
        self._magnitude_reporting_agency_1 = val_magnitude_reporting_agency_1

    magnitude_2 = property(operator.attrgetter('_magnitude_2'))
    
    @magnitude_2.setter
    def magnitude_2(self, val):
        val_magnitude_2 = validateFloat(val, "magnitude_2", -1.0, 9.9, True, self.header_type)
        self._magnitude_2 = val_magnitude_2

    type_of_magnitude_2 = property(operator.attrgetter('_type_of_magnitude_2'))
    
    @type_of_magnitude_2.setter
    def type_of_magnitude_2(self, val):
        val_type_of_magnitude_2 = validateString(val, "type_of_magnitude_2", 0, 1, "", False, self.header_type)
        self._type_of_magnitude_2 = val_type_of_magnitude_2

    magnitude_reporting_agency_2 = property(operator.attrgetter('_magnitude_reporting_agency_2'))
    
    @magnitude_reporting_agency_2.setter
    def magnitude_reporting_agency_2(self, val):
        val_magnitude_reporting_agency_2 = validateString(val, "magnitude_reporting_agency_2", 0, 3, "", False, self.header_type)
        self._magnitude_reporting_agency_2 = val_magnitude_reporting_agency_2

    magnitude_3 = property(operator.attrgetter('_magnitude_3'))
    
    @magnitude_3.setter
    def magnitude_3(self, val):
        val_magnitude_3 = validateFloat(val, "magnitude_3", -1.0, 9.9, True, self.header_type)
        self._magnitude_3 = val_magnitude_3

    type_of_magnitude_3 = property(operator.attrgetter('_type_of_magnitude_3'))
    
    @type_of_magnitude_3.setter
    def type_of_magnitude_3(self, val):
        val_type_of_magnitude_3 = validateString(val, "type_of_magnitude_3", 0, 1, "", False, self.header_type)
        self._type_of_magnitude_3 = val_type_of_magnitude_3

    magnitude_reporting_agency_3 = property(operator.attrgetter('_magnitude_reporting_agency_3'))
    
    @magnitude_reporting_agency_3.setter
    def magnitude_reporting_agency_3(self, val):
        val_magnitude_reporting_agency_3 = validateString(val, "magnitude_reporting_agency_3", 0, 3, "", False, self.header_type)
